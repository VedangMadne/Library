...
export const getHomePageData = () => api.get("/auth/home-data");
...
export const getAllTeachers = async (qEmail, qName, qLastName, page) =>
  await api.get(
    `/teachers?qEmail=${qEmail}&qName=${qName}&qLastName=${qLastName}&page=${page}`
  );
...
export const getAllStudents = async (qName, qLastName, qRollNumber, page) =>
  await api.get(
    `/students?qName=${qName}&qLastName=${qLastName}&qRollNumber=${qRollNumber}&page=${page}`
  );
export const getStudentsByBatch = (batchId) =>
  api.get(`/students/${batchId}`);
...
export const getCategories = () => {
  return api.get("/categories/all"); // Adjust the endpoint as per your backend
};
...
/* ################################   TRANSACTIONS ######################################### */
export const exportIssuedBooks = (qRollNumber) =>
  api.get(`/transactions/files/export?qRollNumber=${qRollNumber}`);
export const storeBackupData = () =>
  api.get(`/transactions/files/backup`);
